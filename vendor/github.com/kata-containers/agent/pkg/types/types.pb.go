...
func (*Neigh) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{2} }

func (m *Neigh) GetIndexname() string {
	if m != nil {
		return m.Indexname
	}
	return ""
...
func (m *Neigh) GetHardwareaddr() string {
	if m != nil {
...
func (*Route) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{3} }
...
func init() {
	...
	proto.RegisterType((*Neigh)(nil), "types.Neigh")
...
func (m *Neigh) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *Neigh) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Indexname) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintTypes(dAtA, i, uint64(len(m.Indexname)))
	...
	if len(m.Hardwareaddr) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintTypes(dAtA, i, uint64(len(m.Hardwareaddr)))
...
func (m *Neigh) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Neigh: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Neigh: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorTypes = []byte{
	...
	,
}
